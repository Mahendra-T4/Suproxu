...
class _PortfolioActiveTabState extends ConsumerState<PortfolioActiveTab>
              ...
              children: [
                ...
                activeProvider.when(
                  ...
                  data: (data) {
                    ...
                    final profitandLoss = data.response?.fold<double>(
                          0.0,
                          (sum, element) =>
                    ...
                    return Column(
                      children: [
                        SizedBox(
                            // height: 100,
                            child: Center(
                                child: _userWallet(profitandLoss, data.status!,
                                    m2m, availebleMargin))),
                        SizedBox(
                          height: 10.h,
                        ),
                                                          ...
                                                          Row(
                                                            children: [
                                                              ...
                                                              Text(
                                                                ...
                                                                style:
                                                                    TextStyle(
                                                                        color: data.response![index].liveData!.profitLoss.toString().contains('-')
                                                                            ? Colors
                                                                                .red
                                                                            : Colors
                                                                                .green,
                                                                    ...
                                                                    try {
                                                                      ...
                                                                      final param =
                                                                        ...
                                                                        categoryName: data
                                                                            ...
                                                                            .dataRelatedTo
                                                                            .toString(),
                                                                        stockPrice: data.response![index].tradeMethod ==
                                                                                1
                                                                            ? getData.response[0].ohlc.salePrice.toString()
                                                                            : getData.response[0].ohlc.buyPrice.toString(),
                                                                        stockQty: data
                                                                            .response![index]
                                                                            .stockQty
                                                                            .toString(),
                                                                      ...
                                                                      final result = await ref.read(data.response![index].tradeMethod == 1
                                                                          ? saleStockProvider(param)
                                                                              .future
                                                                          : buyStockProvider(param)
                                                                              .future);
                                                                      ...
                                                                      if (result
                                                                        ...
                                                                        if (mounted) {
                                                                          ...
                                                                          _portfolioBloc
                                                                              .add(ActivePortfolioDataFetchingEvent());

                                                                          // Remove loading and locked states
                                                                          setState(
                                                                              () {
                                                                            loadingIndices.remove(index);
                                                                            lockedIndices.remove(index); // Unlock immediately on success
                                                                          });
                                                                        ...
                                                                        setState(
                                                                          ...
                                                                          loadingIndices
                                                                              .remove(index);
                                                                          lockedIndices
                                                                              .remove(index); // Unlock on failure too
                                                                        });
                                                                      }
                                                                    } catch (e) {
                                                                      log('Error closing trade: $e');
                                                                      setState(
                                                                          () {
                                                                        loadingIndices
                                                                            .remove(index);
                                                                        lockedIndices
                                                                            .remove(index); // Always unlock on error
                                                                      });
                                                                    }
                                                                  },
                                                                  child:
  ...
  Widget _userWallet(double profitLoss, int status, dynamic m2m,
  ...
  Widget _buildWalletInfoColumn(String label, String value,
