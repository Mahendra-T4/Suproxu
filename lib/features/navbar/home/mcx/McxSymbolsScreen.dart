...
//   const Symbolscreen({super.key, required this.params});

//   static const String routeName = '/mcx-symbol-screen';
...
//                                   Icons.receipt_long,
//                                   color:
//                                       selecteddTab == 1 ? Colors.white : zBlack,
//                                   size: 20,
//                                 ),
//                                 const SizedBox(width: 8),
//                                 Text(
...
//                     //    final records = snapshot.data!.response!.first;
//                     // }
//                     if (snapshot.data!.status == 1) {
//                       record = snapshot.data!.response.first;
//                       ohlcMCX = record.ohlc;
//                     }
//                     // final
//                     final ohlc = ohlcMCX;
...
//                           child: ElevatedButton(
//                             onPressed: () {
//                               if (double.parse(_usernameController.text) >
//                                       double.parse(ohlc.salePrice) ||
//                                   double.parse(_usernameController.text) <
//                                       double.parse(ohlc.buyPrice)) {
//                                 saleStock(
