...
// class MCXStockPage extends ConsumerStatefulWidget {
//   const MCXStockPage({super.key});
//   static const String routeName = '/mcx-stock-panel-page';

//   @override
//   ConsumerState<MCXStockPage> createState() => _MCXStockPageState();
// }

// class _MCXStockPageState extends ConsumerState<MCXStockPage> {
...
//   // final searchQueryProvider = StateProvider<String>((ref) => searchController.text);

//   @override
//   Widget build(BuildContext context) {
//     // final searchQuery = ref.watch(searchQueryProvider);
//     final webSocketState =
//         ref.watch(mcxAllStocksProvider(searchController.text));
...
//     if (webSocketState.errorMessage != null) {
//       return Scaffold(
//         body: Center(
//           child: Column(
//             mainAxisAlignment: MainAxisAlignment.center,
...
//               const SizedBox(height: 16),
//               Text(webSocketState.errorMessage!),
//               const SizedBox(height: 16),
//               ElevatedButton(
//                 onPressed: () {
//                   ref
//                       .read(
//                           mcxAllStocksProvider(searchController.text).notifier)
//                       .reconnect();
//                 },
...
//     if (webSocketState.data == null || webSocketState.data?.response == null) {
//       return Scaffold(
//         body: Center(
//           child: Column(
//             mainAxisAlignment: MainAxisAlignment.center,
...
//               const SizedBox(height: 16),
//               Text('No MCX data available'),
//               if (!webSocketState.isConnected) ...[
//                 const SizedBox(height: 16),
//                 ElevatedButton(
//                   onPressed: () {
//                     ref
//                         .read(mcxAllStocksProvider(searchController.text)
//                             .notifier)
//                         .reconnect();
//                   },
...
//     final data = webSocketState.data!;
...
//                                       compareValue:
//                                           data.response![index].ohlc!.lastPrice,
//                                       currentValue:
//                                           data.response![index].ohlc!.salePrice,
//                                     ),
//                                     SizedBox(width: 10.w),
//                                     BlinkingPriceText(
//                                       assetId: data.response![index].symbolName,
//                                       text:
//                                           "₹${_formatNumber(data.response![index].ohlc!.buyPrice)}",
//                                       compareValue:
//                                           data.response![index].ohlc!.lastPrice,
//                                       currentValue:
//                                           data.response![index].ohlc!.buyPrice,
//                                     ),
...
//                                 ),
//                                 Text(
//                                   _formatNumber(data.response![index].change),
//                                   style: TextStyle(
//                                     color: data.response![index].change
//                                             .toString()
//                                             .contains('-')
...
//                   setState(() {
//                     // This will trigger a rebuild with the new search query
