...
class _LedgerReportScreenState extends State<LedgerReportScreen>
            ...
            child: SafeArea(
              child: Scaffold(
                  ...
                  appBar: customAppBarWithTitle(
                      context: context, title: 'Ledger', isShowNotify: true),
                  body: BlocConsumer(
                    bloc: _profileBloc,
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              _buildTradeHeader(
                                                qnty: int.parse(ledgerEntity
                                                    .record![index].tradeID
                                                    .toString()),
                                                date: ledgerEntity
  ...
  Widget _buildTradeHeader(
      {required int qnty, required String date, required String time}) {
    return Row(
