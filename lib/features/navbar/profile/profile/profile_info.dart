  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: customAppBarWithTitle(
            context: context, title: 'Profile Info', isShowNotify: true),
        body: BlocBuilder(
          bloc: _profileBloc,
          builder: (context, state) {
            switch (state.runtimeType) {
              ...
              case FetchUserProfileInfoSuccessStatus:
                final successState =
                    (state as FetchUserProfileInfoSuccessStatus)
                        .profileInfoModel;
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          state.profileJsonData!['mcxDetails']
                                                  ['mcxBrokerage']
                                              .toString(),
                                          style: const TextStyle(fontSize: 16),
                                        ),
                                    ...
                                    SizedBox(
                                        ...
                                        child:
                                            Text(state.marginUsed.toString())),
