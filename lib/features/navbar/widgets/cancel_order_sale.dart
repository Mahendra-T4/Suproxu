...
class CancelOrderSale extends StatefulWidget {
  const CancelOrderSale({Key? key, required this.params, this.refresh})
      : super(key: key);
  final CancelOrderParams params;
  final VoidCallback? refresh;

  @override
  State<CancelOrderSale> createState() => _CancelOrderSaleState();
}
...
class _CancelOrderSaleState extends State<CancelOrderSale> {
