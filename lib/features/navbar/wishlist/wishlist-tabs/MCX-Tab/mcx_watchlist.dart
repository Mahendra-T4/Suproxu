...
// import 'package:trading_app/features/navbar/wishlist/provider/mcx_wishlist_provider.dart';
...
// class MCXWatchList extends ConsumerStatefulWidget {
//   MCXWatchList({
//     Key? key,
//   }) : super(key: key);

//   @override
//   ConsumerState<MCXWatchList> createState() => _MCXWatchListState();
// }

// class _MCXWatchListState extends ConsumerState<MCXWatchList>
...
//     final mcxWatchListProvider = ref.watch(mcxWishlistProvider);
...
//             isReadOnly: true,
//             onTap: () {
//               context.pushNamed(MCXStockPage.routeName);
//             },
//           ),
//           mcxWatchListProvider.when(
//             skipLoadingOnRefresh: true,
//             data: (data) {
//               if (data.status == 1) {
//                 // Initialize local list if empty or length mismatch
//                 if (_localWatchlist.length !=
//                     (data.mcxWatchlist?.length ?? 0)) {
//                   _localWatchlist = List.from(data.mcxWatchlist ?? []);
//                 }
//                 return Expanded(
...
//               developer.log('Error fetching MCX Wishlist data: $error',
