...
// import 'package:trading_app/core/widgets/app_bar.dart';
...
//   static const String routeName = '/nse-future-stock-wishlist-new';
...
//   final List<String> removingItems = [];
...
//         setState(() {
//           nfoWishlist = data;
//           _localWatchlist = List<NFOWatchList>.from(data.nfoWatchlist ?? []);
//           errorMessage = null;
//         });
//       },
//       onError: (error) {
...
//                     if (nfoWishlist.nfoWatchlist == null) {
//                       return const Center(child: CircularProgressIndicator());
//                     }

//                     if (nfoWishlist.nfoWatchlist!.isEmpty) {
